...
//        new DownloadGeoJsonFile().execute("http://www.haiakids.com/haia/kamiaran%20(2).json");

    }

    private void retrieveFileFromResource() {
        try {
            GeoJsonLayer layer = new GeoJsonLayer(getMap(), R.raw.cc, this);
    ...
    private void addGeoJsonLayerToMap(GeoJsonLayer layer) {
        ...
        layer.addLayerToMap();
        getMap().animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(35.303647, 47.001034), 12.0f), 4000, null);
